...
public class PurchaseDAOImpl implements PurchaseDao {
    ...
    @Override
    public void addPurchase(Purchase purchase, String couponOption)throws ClassNotFoundException,InvalidCouponException {
        try {
    ...
    @Override
    public Purchase getPurchaseById(int id) throws ClassNotFoundException,InvaliIdException {
    ...
    @Override
    public List<Purchase> getAllPurchases() throws ClassNotFoundException{
    ...
    @Override
    public String deletePurchase(int id) throws ClassNotFoundException,InvaliIdException {
        try {
            DbUtil db = DbUtil.getInstance();
            Connection con = db.getConnection();
